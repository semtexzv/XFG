...
namespace XFG.Platform.Windows
{
    class WglDisplay : IDisplay
    {
        ...
        public WglDisplay(AppConfig config, AppListener app)
        {
            ...
            CreateContext(config.DisplayFormat);
        ...
        internal void CreateContext(DisplayFormat requestFormat)
        {
           ...
           bool ES2Support = WglExtensions.Contains("WGL_EXT_create_context_es2_profile");
            ...
            {
                throw new NotSupportedException("Could not create ContextHandle");
            }
